---
  title: "civic-json-worker"
  blurb: "Worker script that pulls metadata about opengov projects"
  skills_needed: []
  repos: 
    - "https://github.com/sfbrigade/civic-json-worker"
  app_link: "https://github.com/sfbrigade/civic-json-worker"
  license: "MIT"
